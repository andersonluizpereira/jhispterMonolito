[![Build Status](https://travis-ci.org/andersonluizpereira/jhispterMonolito.svg?branch=master)](https://travis-ci.org/andersonluizpereira/jhispterMonolito)
...
To optimize the erp application for production, run:
